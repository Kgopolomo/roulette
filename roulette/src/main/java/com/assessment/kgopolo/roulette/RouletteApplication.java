package com.assessment.kgopolo.roulette;


import com.assessment.kgopolo.roulette.player.PlayersLoader;
...
public class RouletteApplication implements ApplicationRunner {
	private static final String PLAYERS_DEFAULT_INPUT_FILE = "players.txt";
